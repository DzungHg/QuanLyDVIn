#pragma checksum "E:\My Datas\Webs by netcore\QuanLyDVIn\src\TheoDoiSXWeb\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d7cf8635bc183a7bef14ee138973293b48e9ec20"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d7cf8635bc183a7bef14ee138973293b48e9ec20", @"/Pages/Index.cshtml")]
    ...
    public class Pages_Index : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        ...
        {
#line 3 "E:\My Datas\Webs by netcore\QuanLyDVIn\src\TheoDoiSXWeb\Pages\Index.cshtml"
  
    ViewData["Title"] = "Home page";

#line default
#line hidden
            BeginContext(71, 73329, true);
            WriteLiteral(@"
 <!-- .app -->
    <div class=""app"">
      <!--[if lt IE 10]>
          ...
          <div class=""top-bar-list"">
            ...
            WriteLiteral(@"            <p class=""text""> Sara Carr invited to Stilearn Admin </p><span class=""date"">5 hours ago</span>
                      ...
                      <a href=""#!"" class=""dropdown-item"">
                        ...
                        <div ");
            WriteLiteral(@"class=""dropdown-item-body"">
  ...
  ");
            ...
            WriteLiteral(@"/div>
                ...
                <li class=""nav-item dropdown header-nav-dropdown"">
                  <a class=""nav-link"" href=""#!"" data-toggle=""dro");
            WriteLiteral(@"pdown"" aria-haspopup=""true"" aria-expanded=""false""><span class=""oi oi-grid-three-up""></span></a>
                  <div class=""dropdown-arrow""></div><!-- .dropdown-menu -->
                  <div class=""dropdown-menu dropdown-menu-rich dropdown-menu-right"">
                    <!-- .dropdown-sheets -->
            ...
            WriteLiteral(@"wn-sheet-item -->
              ...
              <div class=""dropdown"">
                ...
                <div class=""dropdown-menu"">
                  <h6 class=""dropdown-header d-none d-md-block d-lg-none""> Beni Arisandi </h6><a class=""dropdown-item"" href=""user-profile.html""><span class=""dropdown-icon oi oi-person""></sp");
            WriteLiteral(@"an> Profile</a> <a class=""dropdown-item"" href=""auth-signin-v1.html""><span class=""dropdown-icon oi oi-account-logout""></span> Logout</a>
      ...
      <aside class=""app-aside app-aside-light"">
        ...
        <div class=""aside-content"">
          ...
          <header class=""aside-header d-block d-md-none"">
            <!-- .btn-account -->
            <button class=""btn-account"" type=""button"" data-toggle=""collapse"" data-target=""#dropdown-aside""><span class=""user-avatar user-avatar-lg""><img");
            WriteLiteral(@" src=""assets/images/avatars/profile.jpg"" alt=""""></span> <span class=""account-icon""><span class=""fa fa-caret-down fa-lg""></span></span> <span class=""account-summary""><span class=""account-name"">Beni Arisandi</span> <span class=""account-description"">Marketing Manager</span></span></button> <!-- /.btn-account -->
            <!-- .dropdown-aside -->
 ...
 ");
            WriteLiteral(@"                     </ul><!-- /grand child menu -->
                    </li>
                    <li class=""menu-item has-child"">
            ...
            WriteLiteral(@"lass=""menu-item"">
                    ...
                    <li class=""menu-item"">
                      <a href=""auth-page-m");
            WriteLiteral(@"essage.html"" class=""menu-link"">Page Message</a>
                    </li>
                    <li class=""menu-item"">
   ...
   ");
            WriteLiteral(@"             </li><!-- /.menu-item -->
                ...
                <li class=""menu-item has-child"">
                  ...
                  <ul class=""menu"">
                    ...
                    <li class=""menu-item"">
                      <a href=""component-list-views.html"" ");
            WriteLiteral(@"class=""menu-link"">List Views</a>
                    </li>
                    <li class=""menu-item"">
            ...
            WriteLiteral(@"has-child"">
                ...
                <li class=""menu-item has-child"">
                  <");
            WriteLiteral(@"a href=""#"" class=""menu-link""><span class=""menu-icon fa fa-table""></span> <span class=""menu-text"">Tables</span></a> <!-- child menu -->
                  <ul class=""menu"">
                    <li class=""menu-item"">
            ...
            WriteLiteral(@"-item"">
                ...
                <li class=""menu-item has-child"">
                  ...
                  <ul class=""menu"">
                    ...
                    <li class=""menu-item has-child"">
   ");
            WriteLiteral(@"                   <a href=""#"" class=""menu-link"">Menu item</a> <!-- grand child menu -->
                      <ul class=""menu"">
                        <li class=""menu-item"">
                        ...
                        <li class=""menu-item has-child"">
                          ...
                          <ul class=""menu"">
                            ...
                            <li class=""menu-item"">
");
            WriteLiteral(@"                              <a href=""#"" class=""menu-link"">Grand Child item</a>
                            </li>
                            <li class=""menu-item"">
                              <a href=""#"" class=""menu-link"">Grand Child item</a>
                            </li>
     ...
     ");
            ...
            WriteLiteral(@">
                 ...
                 ");
            WriteLiteral(@"   </div><!-- metric column -->
                    <div class=""col-lg-3"">
                      <!-- .metric -->
                ...
                <div class=""row"">
                  ...
                  <div class=""col-12 col-lg-12 col-xl-4"">
                    <!-- .card -->
                    <sect");
            WriteLiteral(@"ion class=""card card-fluid"">
                      <!-- .card-body -->
                      <div class=""card-body"">
                        <!-- .d-flex -->
                          ...
                          <div class=""card-title-control ml-auto"">
                            ...
                            <div class=""dropdown"">
                              ...
                              <div class=""dropdown-menu dropdown-menu-right dropdown-menu-md stop-propagation"">
                                <!-- .custom-control -->
                                <div c");
            WriteLiteral(@"lass=""custom-control custom-radio"">
                                ...
                                <div class=""custom-control custom-radio"">
                                  <in");
            WriteLiteral(@"put type=""radio"" class=""custom-control-input"" id=""dpWeek"" name=""dpFilter"" value=""2"" checked> <label class=""custom-control-label d-flex justify-content-between"" for=""dpWeek""><span>This Week</span> <span class=""text-muted"">Mar 21-27</span></label>
                                </div><!-- /.custom-control -->
                                <!-- .custom-control -->
                                <div class=""custom-control custom-radio"">
                                ...
                                <!-- .custom-control -->
                                <div class=""custom-control custom-radio"">
                                  <input type=""radio"" class=""custom-control-input"" id=""dpYear"" name=""dp");
            WriteLiteral(@"Filter"" value=""4""> <label class=""custom-control-label d-flex justify-content-between"" for=""dpYear""><span>This Year</span> <span class=""text-muted"">2018</span></label>
                                </div><!-- /.custom-control -->
                                <!-- .custom-control -->
                                <div class=""custom-control custom-radio"">
         ...
         ");
                    ...
                    <section class=""card card-fluid"">
                      ...
                      <div class=""card-body"">
                        ...
                        <div class=""text-center pt-3"">
                          <div class=""chart-inline-group"" sty");
            WriteLiteral(@"le=""height:214px"">
                      ...
                      <div class=""card-footer"">
                        <div class=""card-footer-item"">
                          <i class=""fa fa-fw fa-circle text-indigo");
            WriteLiteral(@"""></i> 100% <div class=""text-muted small""> Assigned </div>
                        </div>
                        <div class=""card-footer-item"">
            ...
            ");
            WriteLiteral(@"              <div class=""list-group-item-figure"">
                          ...
                          <div class=""list-group-item-body"">
                            ...
                            <div class=""progress progress-animated bg-transparent rounded-0"" data-toggle=""tooltip"" data-html=""true"" title='&lt;div class=""text-left small""&gt;&lt;i class=""fa fa-fw fa-circle text-purple""&gt;&lt;/i&gt; 2065&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-teal""&gt;&lt;/i&gt; 231&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-red""&gt;&lt;/i&gt; 54&lt;/div&gt;'>
                              <div class=""progress-bar bg-purple"" role=""progressbar"" aria-valuenow=""73.46140163642832"" aria-valuemin=""0"" aria-valuemax=""100"" style=""wid");
            WriteLiteral(@"th: 73.46140163642832%"">
       ...
       ");
            WriteLiteral(@"                 <div class=""list-group-item"">
                          ...
                          <div class=""list-group-item-body"">
                            ...
                            <div class=""progress progress-animated bg-transparent rounded-0"" data-toggle=""tooltip"" data-html=""true"" title='&lt;div class=""text-left small""&gt;&lt;i class=""fa fa-fw fa-circle text-purple""&gt;&lt;/i&gt; 1432&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-teal""&gt;&lt;/i&gt; 406&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-red""&gt;&lt;/i&gt; 49&lt;/div&gt;'>
                              <div class=""progres");
            WriteLiteral(@"s-bar bg-purple"" role=""progressbar"" aria-valuenow=""54.180855088914115"" aria-valuemin=""0"" aria-valuemax=""100"" style=""width: 54.180855088914115%"">
            ...
            WriteLiteral(@"-body -->
                        ...
                        <div class=""list-group-item"">
                          ...
                          <div class=""list-group-item-body"">
                            <!-- .progress -->
                            <div class=""progress progress-animated bg-transparent rounded-0"" data-toggle=""tooltip"" data-html=""true"" title='&lt;div class=""text-left small""&gt;&lt;i class=""fa fa-fw fa-circle text-purple""&gt;&lt;/i&gt; 1271&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-teal""&gt;&lt;/i&gt; 87&lt;b");
            WriteLiteral(@"r&gt;&lt;i class=""fa fa-fw fa-circle text-red""&gt;&lt;/i&gt; 82&lt;/div&gt;'>
            ...
            WriteLiteral(@"=""fa fa-fw fa-circle text-purple""&gt;&lt;/i&gt; 1527&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-teal""&gt;&lt;/i&gt; 205&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-red""&gt;&lt;/i&gt; 151&lt;/div&gt;'>
                              ...
                              <div class=""progress-bar bg-red"" role=""progressbar"" aria-valuenow=""7.434761201378631"" aria-valuemin=""0"" aria-valuemax=""100"" style=""width: 7.4347");
            WriteLiteral(@"61201378631%"">
                        ...
                        <div class=""list-group-item"">
                          ...
                          <div class=""list-group-item-body"">
                            <!-- .progress -->
                            <div class=""progress progress-an");
            WriteLiteral(@"imated bg-transparent rounded-0"" data-toggle=""tooltip"" data-html=""true"" title='&lt;div class=""text-left small""&gt;&lt;i class=""fa fa-fw fa-circle text-purple""&gt;&lt;/i&gt; 643&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-teal""&gt;&lt;/i&gt; 265&lt;br&gt;&lt;i class=""fa fa-fw fa-circle text-red""&gt;&lt;/i&gt; 127&lt;/div&gt;'>
                              ...
                              <div class=""progress");
            WriteLiteral(@"-bar bg-red"" role=""progressbar"" aria-valuenow=""7.286288009179575"" aria-valuemin=""0"" aria-valuemax=""100"" style=""width: 7.286288009179575%"">
            ...
            WriteLiteral(@"          <div class=""list-group-item"">
                        ...
                        <div class=""list-group-item-body"">
                          ...
                          <div class=""progress progress-xs bg-transparent"">
                            <di");
            WriteLiteral(@"v class=""progress-bar bg-purple"" role=""progressbar"" aria-valuenow=""2181"" aria-valuemin=""0"" aria-valuemax=""100"" style=""width: 74%"">
            ...
            WriteLiteral(@"-figure -->
                        ...
                        <div class=""list-group-item-body"">
                          ...
                          <div class=""progress progress-xs bg-transparent"">
                            <div class=""progress-bar bg-yellow"" role=""progressbar"" aria-valuenow=""6683"" aria-valuemin=""0"" a");
            WriteLiteral(@"ria-valuemax=""100"" style=""width: 99%"">
            ...
            WriteLiteral(@"            <h5 class=""card-title"">
                      ...
                      <div class=""list-group-item"">
                        ...
                        <div class=""list-group-item-figure"">
                 ");
            WriteLiteral(@"         <div class=""has-badge"">
            ...
            WriteLiteral(@"2% Complete</span>
                      ...
                      <div class=""list-group-item"">
                        ...
                        <div class=""list-group-item-body"">
                          <h5 class=""card-title"">
                            <a href=""page-project.html"">Syre");
            WriteLiteral(@"na Project</a>
                          </h5>
            ...
            WriteLiteral(@"        <!-- .todo-list -->
                      <div class=""todo-list"">
                        ...
                        <div class=""todo"">
                          <!-- .custom-control -->
                          <div class=""custom-control custom-checkbox"">
                            <input type=""checkbox"" class=""custom-control-input"" id=""todo2"" checked> <labe");
            WriteLiteral(@"l class=""custom-control-label"" for=""todo2"">Mix up a pitcher of sangria</label>
                          </div><!-- /.custom-control -->
                        </div><!-- /.todo -->
                        <!-- .todo -->
                        <div class=""todo"">
                        ...
                        <div class=""todo"">
                          <!-- .custom-control -->
                          <div class=""custom-control custom-checkbox"">
                            <input type=""checkbox"" class=""custom-control-input"" id=""todo4""> <label class=""custom-control-label"" for=""todo4"">Ride a roll");
            WriteLiteral(@"er coaster — <span class=""text-red small"">Overdue in 3 days</span></label>
                          </div><!-- /.custom-control -->
                        </div><!-- /.todo -->
                        <!-- .todo-header -->
            ...
            WriteLiteral(@"ustom-control custom-checkbox"">
                        ...
                        <div class=""todo"">
                          ...
                          <div class=""custom-control custom-checkbox"">
                   ");
            WriteLiteral(@"         <input type=""checkbox"" class=""custom-control-input"" id=""todo8""> <label class=""custom-control-label"" for=""todo8"">Get enough sleep!</label>
                          </div><!-- /.custom-control -->
                        </div><!-- /.todo -->
                      </div><!-- /.todo-list -->
                    </div><!-- /.card-body -->
