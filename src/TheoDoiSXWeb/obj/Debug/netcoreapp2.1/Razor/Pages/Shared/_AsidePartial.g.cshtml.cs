#pragma checksum "F:\GitHub02\QuanLyDVIn\src\TheoDoiSXWeb\Pages\Shared\_AsidePartial.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8ad854710f47050cb9bf9ccbdef06ff9c1bc4dac"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(TheoDoiSXWeb.Pages.Shared.Pages_Shared__AsidePartial), @"mvc.1.0.razor-page", @"/Pages/Shared/_AsidePartial.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure.RazorPageAttribute(@"/Pages/Shared/_AsidePartial.cshtml", typeof(TheoDoiSXWeb.Pages.Shared.Pages_Shared__AsidePartial), null)]
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8ad854710f47050cb9bf9ccbdef06ff9c1bc4dac", @"/Pages/Shared/_AsidePartial.cshtml")]
    ...
    public class Pages_Shared__AsidePartial : global::Microsoft.AspNetCore.Mvc.RazorPages.Page
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            BeginContext(147, 20157, true);
            WriteLiteral(@"
 <aside class=""app-aside app-aside-expand-md app-aside-light"">
        ...
        <div class=""aside-content"">
          ...
          <header class=""aside-header d-block d-md-none"">
            ...
            WriteLiteral(@" Profile</a> <a class=""dropdown-item"" href=""auth-signin-v1.html""><span class=""dropdown-icon oi oi-account-logout""></span> Logout</a>
                  ...
                  <ul class=""menu"">
                    ...
                    <li class=""menu-item has-child"">
                      ...
                      <ul class=""menu"">
                        ...
                        <li class=""menu-item"">
                          <a href=""pa");
            WriteLiteral(@"ge-team-feeds.html"" class=""menu-link"">Feeds</a>
                        </li>
                        <li class=""menu-item"">
   ...
   ");
            WriteLiteral(@"                     <li class=""menu-item"">
                ...
                <!-- .menu-item -->
                <li class=""menu-item has-child"">
                  <a href=""#"" class=""menu-link""><span class=""menu-icon oi oi-wrench""></span> <span class=""menu-text"">Auth</sp");
            WriteLiteral(@"an></a> <!-- child menu -->
                  <ul class=""menu"">
                    <li class=""menu-item"">
           ...
           ");
            WriteLiteral(@"         </li>
                    ...
                    <li class=""menu-item"">
 ");
            WriteLiteral(@"                     <a href=""auth-signup.html"" class=""menu-link"">Sign Up</a>
                    </li>
                    <li class=""menu-item"">
                ...
                <li class=""menu-item has-child"">
                  ...
                  <ul class=""menu"">
                    <li class=""menu-item"">
   ");
            WriteLiteral(@"                   <a href=""user-profile.html"" class=""menu-link"">Profile</a>
                    </li>
                    <li class=""menu-item"">
            ...
            WriteLiteral(@">
                    ...
                    <li class=""menu-item"">
                      <a href=""layout-pagesidebar-fluid");
            WriteLiteral(@".html"" class=""menu-link"">Sidebar Fluid</a>
                    </li>
                    <li class=""menu-item"">
            ...
            WriteLiteral(@"=""menu-item"">
                ...
                <li class=""menu-item has-child"">
                  ...
                  <ul class=""menu"">
                    ...
                    <li class=""menu-item"">
           ");
            WriteLiteral(@"           <a href=""form-pickers.html"" class=""menu-link"">Pickers</a>
                    </li>
                    <li class=""menu-item"">
                ...
                <li class=""menu-item has-child"">
                  ...
                  <ul class=""menu"">
                    ...
                    <li class=""menu-item"">
                      <a href=""table-filters-datat");
            WriteLiteral(@"ables.html"" class=""menu-link"">Filter Columns</a>
                    </li>
                  </ul><!-- /child menu -->
                </li><!-- /.menu-item -->
                <!-- .menu-item -->
            ...
            WriteLiteral(@"em"">
                ...
                <!-- .menu-item -->
  ");
            WriteLiteral(@"              <li class=""menu-item has-child"">
                  ...
                  <ul class=""menu"">
                    ...
                    <li class=""menu-item has-child"">
                      ...
                      <ul class=""menu"">
                        ...
                        <li class=""menu-item has-child"">
                          <a href=""#"" class=""menu-link"">Child item</a> <!-- grand child me");
            WriteLiteral(@"nu -->
                          <ul class=""menu"">
                            <li class=""menu-item"">
